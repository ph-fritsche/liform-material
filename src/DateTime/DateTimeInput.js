...
const validateAspect = (dateUtil, value, aspectValue, aspectIndex) => {
...
const commitAspect = (dateUtil, value, onChange, aspectValue, aspectIndex) => {
...
export const DateTimeInput = React.forwardRef(function DateTimeInput(props, ref) {
    ...
    const validate = useMemo(() => validateAspect.bind(undefined, dateUtil, value), [dateUtil, value])

    const commit = useMemo(() => commitAspect.bind(undefined, dateUtil, value, onChange), [dateUtil, value, onChange])
